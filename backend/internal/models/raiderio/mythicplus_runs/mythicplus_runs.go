// models/raiderio/mythicplus_runs/mythicplus_runs.go
package models
...
// MythicPlusRunsResponse représente la réponse principale de l'API
type MythicPlusRunsResponse struct {
	Rankings       []Ranking `json:"rankings"`
	LeaderboardURL string    `json:"leaderboard_url"`
	Params         APIParams `json:"params"`
}

// APIParams contient les paramètres utilisés pour la requête
...
// Ranking représente un classement avec son score et run associé
type Ranking struct {
	Rank  int     `json:"rank"`
